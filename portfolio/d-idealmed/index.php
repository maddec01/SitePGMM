                    ...
                    <div class="row nested">
                        <div class="col col-span-8 port-left">
                            ...
                            <div class="port-gallery">
                                <div class="img-x"><img src="/portfolio/d-idealmed/pic01.jpg" alt="" /></div>
                                <div class="img-x"><img src="/portfolio/d-idealmed/pic02.jpg" alt="" /></div>
                            </div>
                        </div>
                        <div class="col col-span-4 port-right">
                            <h4>IDEALMED Rugby</h4>
                            <p style="margin: 0;">Rugby poster</p>
                            <p style="margin: 45px 0px;">Poster made for IDEALMED Rugby Universiy Tournament.</p>
                            <h3>Client</h3>
                            <p>IDEALMED</p>
                            <h3>Role</h3>
                            <p>Design</p>
                            ...
                            <p>2016</p>
                            <h3>Website</h3>
                            <p><a href="http://www.idealmed.pt" target="_blank">www.idealmed.pt</a></p>
                        </div>
                    </div>
                </div>
            </section>
